...
namespace DXApplication4.sisstemadelibreria
{
    public static class ConnectionHelper
    {
        static Type[] persistentTypes = new Type[] {
            typeof(Cliente),
            typeof(Departamento),
            typeof(Detalladefactura),
            typeof(Empresa_telefonica),
            typeof(Factura),
            typeof(Marca),
            typeof(Municipio),
            typeof(Permisos),
            typeof(Producto),
            typeof(Producto_has_proveedor),
            typeof(Proveedor),
            typeof(Proveedor_has_municipio),
            typeof(Role),
            typeof(Role_has_permisos),
            typeof(Telefono),
            typeof(Usuario)
        };
        ...
        public const string ConnectionString = @"XpoProvider=MySql;server=localhost;user id=root; password=LINUX1983; database=sisstemadelibreria;persist security info=true;CharSet=utf8;";
